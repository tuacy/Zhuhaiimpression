 ...
 * @version: V1.0
 */
public class CircleRippleBackground extends RelativeLayout {
	...
	public CircleRippleBackground(Context context) {
		super(context);
	}

	public CircleRippleBackground(Context context, AttributeSet attrs) {
		super(context, attrs);
		initAttrs(context, attrs);
	}

	public CircleRippleBackground(Context context, AttributeSet attrs, int defStyleAttr) {
