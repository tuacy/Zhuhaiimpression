package com.tuacy.wuyunxing.zhuhaiimpression.animation;
/*
...
public abstract class BaseItemAnimator extends RecyclerView.ItemAnimator {
	...
	protected void preAnimateRemove(final ViewHolder holder) {
	}
	...
	/**
	 * Check the state of currently pending and running animations. If there are none pending/running, call #dispatchAnimationsFinished() to
